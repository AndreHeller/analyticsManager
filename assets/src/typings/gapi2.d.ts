...
/**
 * GoogleAuth is a singleton class that provides methods to allow the user to sign in 
 * with a Google account, get the user's current sign-in status, get specific data 
 * from the user's Google profile, request additional scopes, and sign out from the current account.
 */
interface GoogleApiOAuth2Object {
    ...
    currentUser: {
        /**
         * Returns a GoogleUserObject that represents the current user. 
         * Note that in a newly-initialized GoogleAuth instance, the current user has not been set. 
         * Use the currentUser.listen() method or the GoogleAuth.then() to get an 
         * initialized GoogleAuth instance.
         */
        get: Function,
    ...
    /**
     * Calls the onInit function when the GoogleApiOAuth2Object object is fully initialized, 
     * or calls the onFailure function if initialization fails.
     */
    then: (inInit: Function, onFailure: (reason: any)=>{})=>{};
    ...
    signIn(options ?: {
         ...
         * Adds 'profile' and 'email' to the requested scopes. Optional. 
         * True if unspecified.
         */
         ...
         * See OpenID Connect Request Parameters. (https://openid.net/specs/openid-connect-basic-1_0.html#RequestParameters) 
         * Optional.
         */
        prompt: any,
...
declare module gapi {
    ...
    export function load(lib: string, callback: Function);
...
declare module gapi.auth2 {
    ...
    export function init(params: {
         ...
         * This is susceptible to modification by clients, so be sure to verify the hosted domain 
         * property of the returned user. Use GoogleUser.getHostedDomain() on the client, and the hd 
         * claim in the ID Token on the server to verify the domain is what you expected. 
         * Optional.
         */
         ...
         * Set to the value of the realm that you are currently using for OpenID 2.0, as described 
         * in OpenID 2.0 (Migration, https://developers.google.com/identity/protocols/OpenID2Migration#openid-connect)
         */
        openid_realm?: any
    }): GoogleApiOAuth2Object;
     ...
     */
    export function getAuthInstance(): GoogleApiOAuth2Object;
